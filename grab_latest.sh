...
DL_X86="$REPO_URL/$LATEST_VERSION/brave-origin-v$LATEST_VERSION-linux-amd64.zip"
TMP_X86=$(mktemp)
...
DL_ARM="$REPO_URL/$LATEST_VERSION/brave-origin-v$LATEST_VERSION-linux-arm64.zip"
TMP_ARM=$(mktemp)
